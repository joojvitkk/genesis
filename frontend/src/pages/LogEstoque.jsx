...
import { 
  ...
  Calendar, User, ChevronLeft, ChevronRight, Hash, Info, X
} from 'lucide-react';
import { BACKEND_URL } from '../App';

export default function LogEstoque() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-8">
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h1 className="text-4xl font-black text-gray-900 dark:text-white uppercase tracking-tighter">Auditoria de Estoque</h1>
          <p className="text-gray-500 font-medium italic">Histórico detalhado de movimentações de fichas</p>
        </div>
        ...
        <form onSubmit={handleSearch} className="flex flex-1 md:max-w-xl items-center gap-3 bg-white dark:bg-zinc-900 p-2 rounded-2xl border border-gray-100 dark:border-zinc-800 shadow-sm">
          ...
          <input 
            type="text" 
            placeholder="Buscar por ficha, usuário ou ação..." 
            value={searchTerm}
          ...
          <select 
            ...
            className="bg-transparent border-none outline-none text-xs font-black uppercase text-gray-500 cursor-pointer pr-4"
          >
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-gray-50 dark:bg-zinc-900/50">
                ...
                <th className="px-8 py-4 text-[10px] font-black text-gray-400 uppercase tracking-widest">Quantidade / Ficha</th>
